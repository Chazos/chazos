    ...
    <div class="mx-auto grid h-full">
        ...
        <div class="lg:grid gap-6 md:grid-cols-5 ">
            <div class="col-span-1 bg-gray-200 min-w-0 p-4 ">
              ...
              <ul>
                  <li class="hover:bg-purple-300 hover:rounded-sm hover:w-full {{ $current_link == "site_set" ? 'bg-purple-500 rounded-sm text-white' : '' }} hover:text-white pl-2 w-full  py-1"><a href="{{ route('admin.settings') }}">Site</a></li>
                  <li class="hover:bg-purple-300 rounded-sm hover:w-full {{ $current_link == "payment_set" ? 'bg-purple-400 rounded-sm text-white' : '' }} hover:text-white pl-2 w-full py-1"><a href="{{ route('admin.settings.payments') }}">Payments</a></li>
              ...
              <ul>
                <li class="hover:bg-purple-300 rounded-sm hover:w-full {{ $current_link == "role_set" ? 'bg-purple-500 rounded-sm text-white' : '' }} hover:text-white pl-2 w-full py-1"><a class="" href="{{ route('admin.settings.roles') }}">Roles</a></li>
              </ul>
              ...
              <ul>
                <li class="hover:bg-purple-300 rounded-sm hover:w-full {{ $current_link == "email_set" ? 'bg-purple-500 rounded-sm text-white' : '' }} hover:text-white pl-2 w-full py-1"><a href="{{ route('admin.settings.email') }}">Email settings</a></li>
                <li class="hover:bg-purple-300 rounded-sm hover:w-full {{ $current_link == "email_templates" ? 'bg-purple-500 rounded-sm text-white' : '' }} hover:text-white pl-2 w-full py-1"><a href="{{ route('admin.settings.email') }}">Templates</a></li>
              </ul>
