    ...
    <div x-show="showCollectionTable">
        ...
        <div class="grid grid-cols-4 gap-2 py-3">
            <button id="modify-table-perms-btn" x-on:click="showPermissionTable = true"
                class="bg-purple-600 text-white hover:bg-purple-400 rounded-md p-2 focus:outline-none">
            ...
            <button x-on:click="showCreateKeyModal = true;"
              id="new_key_button"
                class="bg-purple-600 text-white hover:bg-purple-400 relative block rounded-md  p-2 focus:outline-none">
                <svg class="w-6 h-6 inline-block" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <button x-on:click="showAddField = true; showAddCollectionModel = true; showCollectionNameForm = false"
                class="bg-purple-600 text-white hover:bg-purple-400 relative  block rounded-md  p-2 focus:outline-none">
                <svg class="w-6 h-6 inline-block" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
