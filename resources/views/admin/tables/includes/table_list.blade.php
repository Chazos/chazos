    ...
    <div class="xl:h-60 overflow-y-scroll">
        ...
        <ul>
            @foreach ( $tables as $table )
                <li  class="py-3 hover:bg-purple-400 hover:text-white rounded-full mr-3 px-3 flex justify-between">
                  ...
                  @if ($table->table_name != 'users')
                    ...
                    <button class="" type="button" x-on:click="deleteCollection({{ $table->id }})">
